...
# 🚨 Bust the cache: update marker
RUN echo "Cache bust: July 7, 2025" && \
    wget -O traccar.run https://github.com/traccar/traccar/releases/download/v6.5/traccar-linux-64-6.5.run && \
    chmod +x traccar.run && \
